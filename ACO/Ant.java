...
public class Ant {
    ...
    private float alpha; //move probability parameter
    private float beta; //move probability parameter
    private float delta; //calculate next move wait time parameter
